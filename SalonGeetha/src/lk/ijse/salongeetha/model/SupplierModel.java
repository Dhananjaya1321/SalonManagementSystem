...
public class SupplierModel {
    public static ArrayList<Supplier> getSuppliers() throws SQLException, ClassNotFoundException {
...
//        searchEmployee(employee);
    ...
    public static ArrayList<Supplier> searchSupplier(Supplier supplier) throws SQLException, ClassNotFoundException {
        ArrayList<Supplier> suppliers = new ArrayList<>();
        String setColumn;
